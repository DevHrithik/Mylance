...
export function OnboardingWizard() {
  ...
  const validateStep = () => {
    switch (currentStep) {
      ...
      case 16:
        return data.heardAboutMylance.trim().length > 0;
      default:
        return true;
    }
  };
  ...
  const renderStep = () => {
    const commonClasses = "min-h-screen flex flex-col relative overflow-hidden";
    ...
    const contentWrapper = "flex-1 flex items-center justify-center p-6";
              ...
              <div className="relative z-10 max-w-2xl w-full text-center">
                <div className="mb-8">
                  ...
                  <p className="text-gray-600 italic text-base mb-8">
                    ...
                    and other relevant details to build a strategy for you. Make
                    sure it follows the format https://www.linkedin.com/in/
                  </p>
                </div>
          ...
          <div className={commonClasses}>
            ...
            <div className="relative z-10 max-w-2xl w-full text-center">
              ...
              <div className="mb-8">
                <Input
                  type="text"
                  value={data.heardAboutMylance}
                  onChange={(e) =>
                    updateData("heardAboutMylance", e.target.value)
                  }
                  placeholder="Type your answer here..."
                  className="text-xl border-0 border-b-4 border-teal-500 rounded-none bg-transparent focus:ring-0 focus:outline-none text-center placeholder:text-gray-400"
                />
